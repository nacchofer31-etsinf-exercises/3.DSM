...
/**
 * This is the item provider adapter for a {@link Practica6.Tabla} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TablaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Practica6Package.Literals.TABLA__NOMBRE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Practica6Package.Literals.TABLA__COLUMNAS);
			childrenFeatures.add(Practica6Package.Literals.TABLA__FKS);
		}
	...
	public String getText(Object object) {
		String label = ((Tabla)object).getNombre();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Tabla.class)) {
			case Practica6Package.TABLA__NOMBRE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Practica6Package.TABLA__COLUMNAS:
			case Practica6Package.TABLA__FKS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Practica6Package.Literals.TABLA__COLUMNAS,
				 Practica6Factory.eINSTANCE.createColumna()));

		newChildDescriptors.add
			(createChildParameter
				(Practica6Package.Literals.TABLA__FKS,
				 Practica6Factory.eINSTANCE.createFK()));
	}
